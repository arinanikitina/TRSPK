        ...
        static void Main()
        {
            ...
            switch (op)
            {
                case 1:
                    ...
                    if (age < 13 || age > 19)
                    {
                        Console.WriteLine("Возраст подростка составляет от 13 до 19 лет включительно. Введите возраст еще раз.");
                        while (age < 13 || age > 19)
                        {
                            age = Convert.ToUInt32(Console.ReadLine());
                            if (age < 13 || age > 19)
                ...
                case 2:
                    ...
                    if (age < 16 || age > 70)
                    {
                        Console.WriteLine("Возраст работника составляет от 16 до 70 лет включительно. Введите возраст еще раз.");
                        while (age < 16 || age > 70)
                        {
                            age = Convert.ToUInt32(Console.ReadLine());
                            if (age < 16 || age > 70)
